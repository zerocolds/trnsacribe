...
```
Образ основан на `ghcr.io/vllm-project/vllm-openai:latest`, поэтому vLLM и PyTorch уже предустановлены — остаётся только поднять FastAPI и при необходимости запустить сервис vLLM.
